          ...
          >
            <div className="flex items-center justify-between">
              ...
              {alreadySaved ? (
                <button
                  type="button"
                  className="bg-red-500 opacity-70 hover:opacity-100 text-white font-bold px-5 py-1 rounded-3xl hover:shadow-md outlined-none"
                >
                  {save?.length}Saved
                </button>
              ) : (
            ...
            <div className="flex justify-between items-center gap-2 w-full">
              ...
              {postedBy?._id === user?.googleId && (
                <button
                  ...
                  className="bg-white p-2 rounded-full w-8 h-8 flex items-center justify-center text-dark opacity-75 text-base hover:opacity-100 outline-none"
                >
                  <AiTwotoneDelete />
                </button>
              )}
